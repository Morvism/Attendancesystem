...
if (empty($id)) {
	...
	$save = $conn->query("UPDATE `employee` set اسم='$firstname',نام مستعار='$middlename',فامیل='$lastname',موقعیت='$position',دپارتمان='$department' where id = $id ") or die(mysqli_error());
	if ($save) {
