...
<head>
	<title>افزودن کاربر جهت ورود به پنل</title>
	<meta charset="utf-8" />
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content ">
					<div class="modal-body">
						<center><label class="text-danger">آیا شما از حذف این مورد اطمینان دارید؟</label></center>
						<br />
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content panel-warning">
					<div class="modal-header panel-heading">
						...
						<h4 class="modal-title" id="manage_userlabel">ویرایش مدیر</h4>
					</div>
					<div id="edit_query"></div>
				</div>
			</div>
		</div>
		<div class="alert alert-primary">حساب های مدیریت</div>
		<div class="well col-lg-12">
			<button type="button" class="btn btn-primary btn-sm" id="new_user"><i class="fa fa-plus"></i> افزودن جدید</button>
			<br />
			<br />
			...
			<div class="modal-content panel-primary">
				...
				<form id="user-frm">
					...
					<div class="modal-footer">
						<button class="btn btn-primary" name="save">ذخیره</button>
					</div>
				</form>
			</div>
		</div>
