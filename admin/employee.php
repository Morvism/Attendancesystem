...
<head>
	<title>لیست کارمندان | محل مدیریت کارمندان</title>
...
<body>
	...
	<div class="container-fluid admin">
		<div class="alert alert-primary">لیست کارمندان</div>
		...
		<div class="well col-lg-12">
			<button class="btn btn-success" type="button" id="new_emp_btn"><span class="fa fa-plus"></span> افزودن جدید </button>
			<br />
			<br />
		...
		<div class="modal-dialog modal-centered" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModallabel">افزودن کارمند</h4>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				</div>
				<form id='employee_frm'>
					<div class="modal-body">
						...
						<div class="form-group">
							<label>نام متسعار</label>
							<input type="text" name="middlename" placeholder="اختیاری" class="form-control" />
						</div>
						<div class="form-group">
							<label>فامیل:</label>
					...
					<div class="modal-footer">
						<button class="btn btn-primary" name="save"><span class="glyphicon glyphicon-save"></span> ذخیره</button>
					</div>
				</form>
			</div>
		</div>
				...
				success: function(resp) {
					if (typeof resp != undefined) {
						try {
							...
							console.log('Error parsing JSON:', error, resp);
